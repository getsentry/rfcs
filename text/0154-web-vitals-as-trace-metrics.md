...
| Metrics (unsampled), measured avg ~1,113B/item | 500M metrics (300M LCP/CLS/INP + 200M FCP/TTFB) | ~$278 | 100% |
...
| **Cost reduction (@ measured avg ~1,113B/item)** | TODO: recalculate for current default and streamed/v11 |

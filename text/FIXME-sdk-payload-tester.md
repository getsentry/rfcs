...
This RFC introduces **SDK Payload Tester** (will be referred as "**Payload Tester**" in the rest of the document) -- a new testing service to ensure better validation and integration testing of payloads produced by Sentry SDKs.
